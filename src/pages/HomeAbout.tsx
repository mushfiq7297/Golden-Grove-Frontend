    ...
    <section className="py-24 bg-primary/15">
      <div className="container mx-auto px-6">
        <div className="mx-auto max-w-4xl text-center">
          ...
          {/* Title */}
          <motion.h2
            className="mb-6 text-3xl md:text-4xl font-bold tracking-tight text-muted   dark:text-gray-400"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          {/* Paragraphs */}
          <motion.p
            className="mb-6 text-base md:text-lg text-muted/75    dark:text-gray-400 leading-relaxed"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <motion.p
            className="mb-10 text-base md:text-lg text-muted/75   dark:text-gray-400 leading-relaxed"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
